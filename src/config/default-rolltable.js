// config/default-rolltable.js -- Built-in default rolltable config.
// Source: Shadowdark RPG rolltable

export const defaultRolltableConfig = {
  meta: { algorithm: 'Shadowdark' },
  SECTIONS: {
    'MAJOR EVENT': {
      meta: { source: 'Shadowdark RPG', page: 132 },
      dice: '1d8',
      cols: 1,
      'col headers': [],
      rolls: {
    ...
    'POINTS OF INTEREST': {
      meta: { source: 'Shadowdark RPG', page: 133 },
      dice: '1d20',
      cols: 2,
      ...
      rolls: {
        ...
        '20': ['Holy shrine', 'Has a door to another plane'],
      },
    },
    'POI CHECK': {
      meta: { source: 'Custom Rule', page: null },
      dice: '1d6',
      cols: 1,
      'col headers': [],
      rolls: {
